...
- tconstruct:enchantment_converting: 10
...
- tconstruct:modifier_salvage: 133
...
- tconstruct:multilevel_modifier: 2
...
- tconstruct:retextured_casting_basin: 2
