...
/**
 * Fluid handler for a container holding a constant fluid that empties into a fixed item.
 *
 * <p>Fabric port: the Forge capability-provider half is gone; instances are exposed through
 * {@code FluidStorage.ITEM} registrations in {@code TinkerFluidStorage}.
 */
public class ConstantFluidContainerWrapper implements IFluidHandlerItem {
  ...
  public FluidStack drain(int maxDrain, FluidAction action) {
    // cannot drain if: already drained, or requested too little
