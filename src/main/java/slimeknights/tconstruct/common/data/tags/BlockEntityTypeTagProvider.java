...
public class BlockEntityTypeTagProvider extends BuiltinRegistryTagProvider<BlockEntityType<?>> {
  ...
  public BlockEntityTypeTagProvider(PackOutput packOutput, CompletableFuture<Provider> lookupProvider, @Nullable ExistingFileHelper existingFileHelper) {
    super(packOutput, BuiltInRegistries.BLOCK_ENTITY_TYPE, lookupProvider, TConstruct.MOD_ID, existingFileHelper);
  }
