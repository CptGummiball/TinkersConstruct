...
public class SeveringRecipeBuilder extends AbstractRecipeBuilder<SeveringRecipeBuilder> {
  ...
  public void save(RecipeOutput consumer, ResourceLocation id) {
    ...
    if (childOutput != null) {
      consumer.accept(id, new AgeableSeveringRecipe(id, ingredient, output, childOutput, baseChance, lootingBonus), advancementId);
    } else {
      consumer.accept(id, new SeveringRecipe(id, ingredient, output, baseChance, lootingBonus), advancementId);
    }
  }
}
