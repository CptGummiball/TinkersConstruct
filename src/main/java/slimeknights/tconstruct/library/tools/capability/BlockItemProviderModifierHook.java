...
public interface BlockItemProviderModifierHook {
    ...
    // Forge exposed CapabilityImpl through ToolCapabilityProvider; on Fabric the dispatch
    // lives directly in BlockItemProviderCapability.getBlockProvider, so no provider class.
}
