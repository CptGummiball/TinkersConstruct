...
public class AddToolDataFunction extends LootItemConditionalFunction {
  ...
  /** Loot codec, keeps the 1.20 JSON shape: optional "damage_percent" and "materials" list */
  public static final MapCodec<AddToolDataFunction> CODEC = RecordCodecBuilder.mapCodec(instance ->
    commonFields(instance).and(instance.group(
      ...
      new LoadableCodec<>(RandomMaterial.LOADER.list(0)).optionalFieldOf("materials", List.<RandomMaterial>of()).forGetter(function -> function.materials)
