...
public class TintedArmorTexture implements ArmorTexture {
  ...
  @Override
  public void renderTexture(Model model, PoseStack matrices, MultiBufferSource bufferSource, int packedLight, int packedOverlay, int tint, boolean hasGlint) {
    ...
    AbstractArmorModel.renderColored(model, matrices, buffer, packedLight, packedOverlay, color, tint);
  }
}
