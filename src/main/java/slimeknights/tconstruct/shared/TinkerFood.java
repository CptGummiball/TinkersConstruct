...
public final class TinkerFood {
  ...
  public static final FoodProperties EARTH_CAKE = new FoodProperties.Builder().nutrition(1).saturationModifier(0.3f).alwaysEdible().effect(new MobEffectInstance(TinkerEffects.bouncy.get().holder(),      30 * 20, 0), 1.0f).build();
  public static final FoodProperties SKY_CAKE   = new FoodProperties.Builder().nutrition(1).saturationModifier(0.2f).alwaysEdible().effect(new MobEffectInstance(TinkerEffects.doubleJump.get().holder(),  30 * 20, 0), 1.0f).build();
  public static final FoodProperties ICHOR_CAKE = new FoodProperties.Builder().nutrition(1).saturationModifier(0.3f).alwaysEdible().effect(new MobEffectInstance(TinkerEffects.antigravity.get().holder(), 30 * 20, 0), 1.0f).build();
  public static final FoodProperties ENDER_CAKE = new FoodProperties.Builder().nutrition(1).saturationModifier(0.4f).alwaysEdible().effect(new MobEffectInstance(TinkerEffects.returning.get().holder(),   30 * 20, 0), 1.0f).fast().build();
  ...
  public static final FoodProperties EARTH_BOTTLE = new FoodProperties.Builder().alwaysEdible().effect(new MobEffectInstance(TinkerEffects.experienced.get().holder(),  120 * 20), 1.0f).effect(new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN, 120 * 20, 1), 1.0f).build();
  public static final FoodProperties SKY_BOTTLE   = new FoodProperties.Builder().alwaysEdible().effect(new MobEffectInstance(TinkerEffects.ricochet.get().holder(),     120 * 20), 1.0f).effect(new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN, 120 * 20, 1), 1.0f).build();
  ...
  public static final FoodProperties ENDER_BOTTLE = new FoodProperties.Builder().alwaysEdible().effect(new MobEffectInstance(TinkerEffects.enderference.get().holder(),  60 * 20), 1.0f).effect(new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN,  60 * 20, 1), 1.0f).build();
