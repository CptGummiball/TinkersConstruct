...
public class TinkerPartSpriteProvider extends AbstractPartSpriteProvider {
  ...
  protected void addAllSpites() {
    ...
    for (ArmorItem.Type slot : new ArmorItem.Type[] {ArmorItem.Type.HELMET, ArmorItem.Type.CHESTPLATE, ArmorItem.Type.LEGGINGS, ArmorItem.Type.BOOTS} /* PORT: values() minus 1.21's BODY animal armor, tinkers gear has no piece for it; enum order kept for the generated file order */) {
