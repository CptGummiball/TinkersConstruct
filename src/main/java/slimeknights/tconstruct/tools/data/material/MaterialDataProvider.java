...
public class MaterialDataProvider extends AbstractMaterialDataProvider {
  ...
  protected void addMaterials() {
    ...
    addMaterial(MaterialIds.treatedWood, 2, ORDER_COMPAT + ORDER_GENERAL, true, false,
      ConditionHelper.or(ConfigEnabledCondition.FORCE_INTEGRATION_MATERIALS, tagExistsCondition("treated_wood"), new TagFilledCondition<>(TagKey.create(Registries.FLUID, commonResource("creosote")))));
    ...
    addCompatAlloy(MaterialIds.pewter,          3, ORDER_COMPAT + ORDER_WEAPON,  ConditionHelper.or(tagExistsCondition("ingots/tin"), tagExistsCondition("ingots/lead")));
    ...
    addCompatAlloy(MaterialIds.nicrosil, 4, ORDER_COMPAT + ORDER_WEAPON,  ConditionHelper.or(tagExistsCondition("ingots/tin"), tagExistsCondition("ingots/nickel"), tagExistsCondition("ingots/chromium")));
    ...
    addRedirect(id("tungsten"),
      ...
      conditionalRedirect(MaterialIds.invar, ConditionHelper.or(tagExistsCondition("ingots/invar"), tagExistsCondition("ingots/nickel"))),
