...
public class BouncyModifier extends NoLevelsModifier {
  ...
  protected void registerHooks(Builder hookBuilder) {
    ...
    hookBuilder.addModule(AttributeModule.builder(TinkerAttributes.BOUNCY.value(), Operation.ADD_VALUE).uniqueFrom(getId()).tooltipStyle(TooltipStyle.NONE).flat(1));
  }
}
