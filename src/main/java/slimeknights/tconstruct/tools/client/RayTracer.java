...
public class RayTracer {
  ...
  public static double getBlockReachDistance(Player player) {
    // 1.21 made reach a vanilla attribute, so the Forge attribute and the client/server split it
    // needed both collapse into one call that is correct on either side
