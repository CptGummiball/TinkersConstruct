...
public class LeaveVineDecorator extends TreeDecorator {
  public static final MapCodec<LeaveVineDecorator> CODEC = RecordCodecBuilder.<LeaveVineDecorator>mapCodec(inst ->
    inst.group(
      BuiltInRegistries.BLOCK.byNameCodec().fieldOf("vines").forGetter(LeaveVineDecorator::getVines),
      Codec.floatRange(0.0F, 1.0F).fieldOf("probability").forGetter(LeaveVineDecorator::getProbability)
