...
public class SourcesCommand {
  ...
  private static final DynamicCommandExceptionType NOT_FOUND = new DynamicCommandExceptionType(id -> net.minecraft.network.chat.Component.translatable("command.mantle.sources.not_found", String.valueOf(id)));
