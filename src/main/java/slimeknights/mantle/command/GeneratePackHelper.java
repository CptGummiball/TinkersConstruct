...
public class GeneratePackHelper {
  ...
  public static final DynamicCommandExceptionType FAILED_SAVE = new DynamicCommandExceptionType(id -> net.minecraft.network.chat.Component.translatable("command.mantle.remove.failed_save", id));
