...
public class BlockDeferredRegister extends DeferredRegisterWrapper<Block> {
  ...
  public RegistryObject<FlowerPotBlock> registerPotted(String name, Supplier<? extends Block> block) {
    RegistryObject<FlowerPotBlock> potted = registerNoItem("potted_" + name, () -> new FlowerPotBlock(block.get(), POTTED_PROPS));
    // Forge's FlowerPotBlock.addPlant has no vanilla/Fabric counterpart; the empty-pot
    // interaction for these registers with the world module in phase 4.
    return potted;
  }
