...
public class FluidStackLoadable {
  ...
  public static final Loadable<FluidStack> OPTIONAL_BUCKET = fixedSize(FluidStack.BUCKET_VOLUME);
  ...
  public static final RecordLoadable<FluidStack> OPTIONAL_BUCKET_NBT = fixedSizeNBT(FluidStack.BUCKET_VOLUME);
