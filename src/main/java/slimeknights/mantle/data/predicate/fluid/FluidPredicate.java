...
public interface FluidPredicate extends IJsonPredicate<Fluid> {
  ...
  FluidPredicate LIGHTER_THAN_AIR = simple(fluid -> net.fabricmc.fabric.api.transfer.v1.fluid.FluidVariantAttributes
    .isLighterThanAir(net.fabricmc.fabric.api.transfer.v1.fluid.FluidVariant.of(fluid)));
