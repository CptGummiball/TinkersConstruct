...
public interface ItemPredicate extends IJsonPredicate<Item> {
  ...
  // MAY_HAVE_TRANSFER is omitted until mantle.fluid.transfer is ported; it belongs with the
  // fluid module rather than here, and has no users anywhere in Mantle or TConstruct.
